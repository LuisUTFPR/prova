export default function Header() {
    return (
      ...
      <div
        className="container mx-auto flex flex-col md:flex-row md:justify-between items-center"
      >
        <div
          ...
          <nav>
            <ul className="flex space-x-4 text-white md:text-right">
              <li>
                <a
                  href="#"
                  className="linetext-white bg-orange-500 px-4 md:px-8 py-2 rounded hover:bg-blue-600 hover:text-white"
                  >Contact Us</a
                >
              </li>
            </ul>
      ...
      <div
        className="container mx-auto mt-4 md:mt-40 text-left text-white m-4 md:m-10"
      >
        <div className="md:ml-4 w-full md:w-2/3 mx-auto">
          <h2 className="text-2xl md:text-6xl lg:text-7xl font-bold">
          ...
          <div className="mt-10 md:mt-20">
            <a
              href="#"
              className="bg-orange-500 text-white text-lg font-semibold px-4 py-2 md:px-6 md:py-3 rounded hover:bg-blue-600 transition duration-300 mt-2"
              >See Services</a
            >
          </div>
        </div>
